...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'List View')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Blogs', 'title' => 'List View')); ?>
                                                ...
                                                <div class="col-xxl-9 col-lg-7">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                                        <span class="text-muted"><i
                                                            ...
                                                            href="pages-profile.php"><i class="ri-user-3-line me-1"></i>
                                                            Admin</a>
                                                    </div>
