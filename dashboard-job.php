                        ...
                        <div class="col-xl-6">
                            <div class="card card-height-100">
                                <div class="card-header align-items-center d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <a href="#!" class="btn btn-soft-primary btn-sm material-shadow-none">View All
                                            Companies <i class="ri-arrow-right-line align-bottom"></i></a>
                                    </div>
                                </div><!-- end card header -->
                                        ...
                                        <table class="table table-centered table-hover align-middle table-nowrap mb-0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!"
                                                            class="btn btn-link btn-sm material-shadow-none">View More
                                    ...
                                    <div class="row g-0 text-center">
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span class="counter-value" data-target="3364">0</span>
                                                </h5>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span class="counter-value" data-target="2804">0</span>
                                                </h5>
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="p-3 border border-dashed border-start-0">
                                                <h5 class="mb-1"><span class="counter-value" data-target="2402">0</span>
                                                </h5>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-shrink-0">
                                            <a href="apps-job-candidate-lists.php" class="link-primary">View All <i
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 mb-1 text-truncate"><span
                                                                    ...
                                                                    <span class="text-muted fw-normal">@nicholas</span>
                                                                </h5>
                                                                <div class="d-none candidate-position">Assistant / Store
                                                                    Keeper</div>
                                                            </div>
                                                        </a>
                                                    </li>
