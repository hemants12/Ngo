                            ...
                            <div class="card card-animate bg-info">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        ...
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-white bg-opacity-25 rounded fs-3 material-shadow">
                            ...
                            <div class="card bg-success card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-white bg-opacity-25 text-white rounded-2 fs-2 material-shadow">
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-warning-subtle text-warning rounded-2 fs-2 material-shadow">
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-danger-subtle text-danger rounded-2 fs-2 material-shadow">
                            ...
                            <div class="card card-height-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm flex-shrink-0">
                                            <span
                                                class="avatar-title bg-info-subtle text-info rounded-2 fs-2 material-shadow">
                                                    ...
                                                    <div class="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div class="flex-grow-1 ms-3">
                                                            ...
                                                            <p class="text-muted mb-2"><span class="text-danger">
                                                                    2 days left</span> notification to submit the
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card card-height-100">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <div class="apex-charts" data-colors='["--vz-success" , "--vz-transparent"]'
                                            dir="ltr" id="results_sparkline_charts"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-height-100">
                                <div class="d-flex">
                                    <div class="flex-grow-1 p-3">
                                        ...
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                    class="ri-arrow-up-line align-middle"></i> 34.24 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="apex-charts" data-colors='["--vz-danger" , "--vz-transparent"]'
                                            dir="ltr" id="results_sparkline_charts2"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-height-100">
                                <div class="d-flex">
                                    <div class="flex-grow-1 p-3">
                                        ...
                                        <p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i
                                                    class="ri-arrow-up-line align-middle"></i> 6.67 % </span> vs.
                                            previous month</p>
                                    </div>
                                    <div>
                                        <div class="apex-charts" data-colors='["--vz-success" , "--vz-transparent"]'
                                            dir="ltr" id="results_sparkline_charts3"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <li class="list-group-item px-0">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 avatar-xs">
                                                    <span
                                                        class="avatar-title bg-light p-1 rounded-circle material-shadow">
                                            ...
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    ...
                                                    <div class="pt-3">
                                                        ...
                                                        <a href="#!">
                                                            <h6 class="fs-15 lh-base text-truncate mb-0">350 ml Glass
                                                                Grocery Container</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    ...
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                                            <h6 class="fs-15 lh-base text-truncate mb-0">Fabric Dual
                                                                Tone Living Room Chair</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    ...
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                                            <h6 class="fs-15 lh-base text-truncate mb-0">Crux
                                                                Motorsports Helmet</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide" style="max-width: 200px;">
                                                <div>
                                                    ...
                                                    <div class="pt-3">
                                                        <h5 class="text-secondary">$99.94</h5>
                                                        <a href="#!">
                                                            <h6 class="fs-15 lh-base text-truncate mb-0">Half Sleeve
                                                                T-Shirts (Blue)</h6>
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-height-100">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted pb-1">If you couldn't relate to the information in the previous
                                        point, you might be looking for the singlet T-shirt, which is also known as the
                                        half T-shirt.</p>
                                    ...
                                    <div class="notification-elem" id="notification-overlay">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-4 pt-2">
                                                ...
                                                <div>
                                                    <button type="button" class="btn btn-success btn-sm w-sm"
                                                        id="back-btn">Back to Home</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex mb-4 align-items-center">
                                        <div class="flex-grow-1">
                                            <h5 class="text-primary fs-18 mb-0"><span>$48.20</span> <small
                                                    class="text-decoration-line-through text-muted fs-13">$124.10</small>
                                            </h5>
                                        </div>
                                                ...
                                                <ul class="list-unstyled mb-0 pt-2" id="candidate-list">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 mb-1 text-truncate"><span
                                                                        class="candidate-name">Anna Adame</span> <span
                                                                        class="text-muted fw-normal">@Anna</span></h5>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 mb-1 text-truncate"><span
                                                                        class="candidate-name">Patricia Cavin</span>
                                                                    <span class="text-muted fw-normal">@Patricia</span>
                                                                </h5>
                                                                <div class="d-none candidate-position">Web Developer
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 mb-1 text-truncate"><span
                                                                        class="candidate-name">Jason Tran</span> <span
                                                                        class="text-muted fw-normal">@Jason</span></h5>
                                                                <div class="d-none candidate-position">Magento Developer
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="d-none candidate-position">Product Designer
                                                                </div>
                                                            </div>
                                                        </a>
                                                    </li>
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="fs-13 mb-1 text-truncate"><span
                                                                    ...
                                                                    <span class="text-muted fw-normal">@Jennifer</span>
                                                                </h5>
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-4">
                                                    <div>
                                                        ...
                                                        <div id="card-holder-elem" class="fw-medium fs-14">Full Name
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                    ...
                                    <form id="custom-card-form" autocomplete="off">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div>
                                                    <label for="expiry-month-input" class="form-label">Expiry
                                                        Month</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div>
                                                    <label for="expiry-year-input" class="form-label">Expiry
                                                        Year</label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="cvc">
                                                    ...
                                                    <input type="text" id="cvc-input" class="form-control"
                                                        maxlength="3" />
                                                </div>
                                            </div>
                                            <!-- end col -->
