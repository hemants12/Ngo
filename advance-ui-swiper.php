                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>default-swiper</code> class to set a default swiper.
                                    </p>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>navigation-swiper</code> class to set a swiper with
                                        navigation and pagination.</p>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>pagination-dynamic-swiper</code> class to set a
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>pagination-fraction-swiper</code> class to set a
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>pagination-custom-swiper</code> class to set a
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>pagination-progress-swiper</code> class to set a
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>pagination-scrollbar-swiper</code> class to set a
                                        swiper with scrollbar pagination.</p>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>vertical-swiper</code> class to set a vertical
                                        swiper.</p>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>mousewheel-control-swiper</code> class to set a
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>effect-fade-swiper</code> class to set a swiper with
                                        fade effect.</p>
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>effect-creative-swiper</code> class to set a swiper
                        ...
                        <div class="col-xl-4 col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>effect-flip-swiper</code> class to set a swiper with
                                        flip effect.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>effect-coverflow-swiper</code> class to set a swiper
                                        with coverflow effect.</p>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p class="text-muted">Use <code>responsive-swiper</code> class to set a responsive
                                        swiper.</p>
