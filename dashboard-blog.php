...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Blog')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Dashboards', 'title' => 'Blog')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <div class="card">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="dropdown card-header-dropdown">
                                                    <a class="text-reset dropdown-btn" href="#"
                                                        ...
                                                        </span><span class="text-muted">Current Week<i
                                        ...
                                        <div class="card-body">
                                            <div id="column_chart_datalabel" data-colors='["--vz-primary"]'
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex gap-2 align-items-center mb-2">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <div
                                                        class="avatar-title bg-primary-subtle text-primary rounded-2 fs-17">
                                            ...
                                            <div class="d-flex gap-2 align-items-center mb-2">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <div
                                                        class="avatar-title bg-danger-subtle text-danger rounded-2 fs-17">
                                            ...
                                            <div class="d-flex gap-2 align-items-center mb-2">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <div
                                                        class="avatar-title bg-success-subtle text-success rounded-2 fs-17">
                                            ...
                                            <div class="d-flex gap-2 align-items-center">
                                                <div class="avatar-xs flex-shrink-0">
                                                    <div
                                                        class="avatar-title bg-secondary-subtle text-secondary rounded-2 fs-17">
                                        ...
                                        <div class="vstack gap-3">
                                            <div class="d-flex gap-3">
                                                ...
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Diana Kohler <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Really well-written and informative.
                                                        The emotional connection strategy is something I’ll be testing
                                                        out more! "</p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-5.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Tonya Noble <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Incredibly helpful tips, especially
                                                        about adding a call to action. I’ve been missing that step and
                                                        will implement it in my next post! "</p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-6.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Donald Palmer <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Fantastic read! The power of visuals
                                                        and trends really stood out to me. Thanks for sharing these
                                                        useful insights! "</p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-7.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Joseph Parker <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Great post! Simple yet powerful tips
                                                        that I can start using immediately. Thanks for sharing your
                                                        expertise! "</p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-9.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Timothy Smith <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Wow, this has opened my eyes to a new
                                                        perspective on creating content. Emotional triggers—such a smart
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-10.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Alexis Clarke <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Fantastic read! The power of visuals
                                                        and trends really stood out to me. Thanks for sharing these
                                                        useful insights! "</p>
                                            ...
                                            <div class="d-flex gap-3">
                                                <img src="assets/images/users/avatar-2.jpg" alt=""
                                                    class="avatar-sm rounded flex-shrink-0">
                                                <div class="flex-shrink-1">
                                                    <h6 class="mb-2">Thomas Taylor <span class="text-muted">Has
                                                            commented</span></h6>
                                                    <p class="text-muted mb-0">" Loved the section on visual
                                                        storytelling. It’s true that images speak louder on social media
                                                        platforms. More visuals in my next posts for sure! "</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#!" class="text-body fw-medium">The Evolution of
                                                            Minimalism in Design</a>
                                                    </td>
                                                    <td>20 Sep, 2024</td>
                                                    <td><span
                                                            class="badge bg-success-subtle text-success p-2">MinimalDesign</span>
                                                    </td>
                                                    <td>23</td>
                                                    <td>157</td>
                                                    <td>11</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="assets/images/blog/img-3.jpg" alt=""
                                                            class="me-2 rounded" height="40">
                                                        <a href="#!" class="text-body fw-medium">Mastering User
                                                            Experience Through Storytelling</a>
                                                    </td>
                                                    <td>11 Feb, 2024</td>
                                                    <td><span
                                                            class="badge bg-success-subtle text-success p-2">UXDesign</span>
                                                    </td>
                                                    <td>547</td>
                                                    <td>1458</td>
                                                    <td>317</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="assets/images/blog/img-4.jpg" alt=""
                                                            class="me-2 rounded" height="40">
                                                        <a href="#!" class="text-body fw-medium">Designing for Purpose:
                                                            A Mindful Approach</a>
                                                    </td>
                                                    <td>15 Sep, 2024</td>
                                                    <td><span
                                                            class="badge bg-success-subtle text-success p-2">CreativeProcess</span>
                                                    </td>
                                                    <td>88</td>
                                                    <td>649</td>
                                                    <td>237</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="assets/images/blog/img-5.jpg" alt=""
                                                            class="me-2 rounded" height="40">
                                                        <a href="#!" class="text-body fw-medium">How to Overcome
                                                            Creative Block</a>
                                                    </td>
                                                    <td>09 July, 2024</td>
                                                    <td><span
                                                            class="badge bg-success-subtle text-success p-2">CreativeBlock</span>
                                                    </td>
                                                    <td>67</td>
                                                    <td>1114</td>
                                                    <td>1547</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="assets/images/blog/img-6.jpg" alt=""
                                                            class="me-2 rounded" height="40">
                                                        <a href="#!" class="text-body fw-medium">Building Brand Identity
                                                            through Design</a>
                                                    </td>
                                                    <td>19 Nov, 2024</td>
                                                    <td><span
                                                            class="badge bg-success-subtle text-success p-2">BrandDesign</span>
                                                    </td>
                                                    <td>8</td>
                                                    <td>10</td>
                                                    <td>7</td>
