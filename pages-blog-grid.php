...
<head>
    ...
    <?php includeFileWithVariables('layouts/title-meta.php', array('title' => 'Grid View')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php includeFileWithVariables('layouts/page-title.php', array('pagetitle' => 'Blogs', 'title' => 'Grid View')); ?>
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card overflow-hidden blog-grid-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="pages-blog-overview.php" class="text-reset">The
                                    ...
                                    <a href="pages-blog-overview.php"
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card overflow-hidden blog-grid-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="pages-blog-overview.php" class="text-reset">Next
                                            Gen Creators</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card overflow-hidden blog-grid-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="pages-blog-overview.php" class="text-reset">Life by
                                            Design</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card overflow-hidden blog-grid-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="pages-blog-overview.php" class="text-reset">Crafted
                                            Perspectives</a></h5>
                        ...
                        <div class="col-xxl-3 col-lg-6">
                            <div class="card overflow-hidden blog-grid-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><a href="pages-blog-overview.php" class="text-reset">Beyond
                                            the Blueprint</a></h5>
