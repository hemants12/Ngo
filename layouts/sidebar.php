                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="dashboard-blog.php" class="nav-link"><span data-key="t-blog">Blog</span> <span
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarBlogs">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="pages-blog-list.php" class="nav-link" data-key="t-list-view">List
                                                View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="pages-blog-grid.php" class="nav-link" data-key="t-grid-view">Grid
                                                View</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="pages-blog-overview.php" class="nav-link"
                                                data-key="t-overview">Overview</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-range-area.php" class="nav-link"
                                                data-key="t-range-area">Range Area</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-funnel.php" class="nav-link"
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-slope.php" class="nav-link"><span
