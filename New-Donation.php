                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="areaStreet" name="areaStreet" placeholder="Enter your area/street" required>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="idProof" name="idProof" placeholder="Enter Your Pan Card Number" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" id="Donationfor" name="Donationfor" placeholder="Donation For Like ( Poor Children, For Animal, etc. )" required>
                                            </div>
                                        </div>
                                    </div>
