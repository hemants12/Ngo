                                ...
                                if ($campaignData) {
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="campaignName" name="campaignName" value="<?php echo htmlspecialchars($campaignData['name']); ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="campaignType">Campaign Type</label>
                                            <select class="form-control" id="campaignType" name="campaignType" required>
                                                <option value="fundraiser" <?php if ($campaignData['type'] == 'fundraiser') echo 'selected'; ?>>Fundraiser</option>
                                                <option value="petition" <?php if ($campaignData['type'] == 'petition') echo 'selected'; ?>>Petition</option>
                                                <option value="awareness" <?php if ($campaignData['type'] == 'awareness') echo 'selected'; ?>>Awareness</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <label for="startDate">Start Date</label>
                                            <input type="date" class="form-control" id="startDate" name="startDate" value="<?php echo htmlspecialchars($campaignData['start_date']); ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="endDate">End Date</label>
                                            <input type="date" class="form-control" id="endDate" name="endDate" value="<?php echo htmlspecialchars($campaignData['end_date']); ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="campaignDescription">Campaign Description</label>
                                            <textarea class="form-control" id="campaignDescription" name="campaignDescription" rows="4" required><?php echo htmlspecialchars($campaignData['description']); ?></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="targetGoal">Target Goal</label>
                                            <input type="number" class="form-control" id="targetGoal" name="targetGoal" value="<?php echo htmlspecialchars($campaignData['target_goal']); ?>" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p>Current Image: <a href="<?php echo $campaignData['image']; ?>" target="_blank">View</a></p>
                                        </div>

                                        <div class="form-group">
                                            <label for="campaignStatus">Status</label>
                                            <select class="form-control" id="campaignStatus" name="campaignStatus" required>
                                                <option value="active" <?php if ($campaignData['status'] == 'active') echo 'selected'; ?>>Active</option>
                                                <option value="inactive" <?php if ($campaignData['status'] == 'inactive') echo 'selected'; ?>>Inactive</option>
                                            </select>
                                        </div>
